...
function App() {
  ...
  return (
    <>
      ...
      <div className={`navigation-routes ${location.pathname === "/" || location.pathname.includes("/service/") || location.pathname.includes("/services") || location.pathname.includes("/services/me") || location.pathname.includes("/orders") || location.pathname.includes("/account") || location.pathname.includes("/review") ? "h-100" : "" }`} onClick={() => {
