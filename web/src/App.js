...
function App() {
  ...
  return (
    <>
      ...
      <div className={`navigation-routes ${location.pathname === "/" || location.pathname.includes("/services") || location.pathname.includes("/account") || location.pathname.includes("/review") ? "h-100" : "" }`} onClick={() => {
